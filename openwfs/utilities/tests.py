...
from ..simulation import SLM, Microscope, StaticSource

def get_microscope_setup():
    """
        Convenience function returning a basic microscope setup for testing purposes. The microscope has a static source representing a point source, and an SLM as incident field. The microscope parameters are:
